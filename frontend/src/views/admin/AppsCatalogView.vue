  ...
  >
    ...
    <div class="grid sm:grid-cols-2 gap-4">
      ...
      <Field
        ...
        :hint="
          imagesLoading
            ? '클러스터의 이미지 디렉터리에 있는 컨테이너 이미지(.sif·.sqsh). 목록을 불러오는 중입니다 — 기다리지 않고 직접 입력해도 됩니다.'
            : '클러스터의 이미지 디렉터리에 있는 컨테이너 이미지(.sif·.sqsh)만 목록에 뜹니다(전 클러스터 합집합). 아직 올리지 않은 파일명을 미리 적어 둘 수도 있습니다. 비우면 코드 카탈로그의 기본 이미지를 씁니다.'
        "
      >
        <!--
